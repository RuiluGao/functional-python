# Functional Python [![](https://github.com/RuiluGao/functional-python/workflows/tests/badge.svg)](https://github.com/RuiluGao/functional-python/actions?query=workflow%3Atests)
